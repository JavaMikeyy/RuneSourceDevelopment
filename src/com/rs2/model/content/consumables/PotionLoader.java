...
public class PotionLoader {
	...
	public static void loadPotionDefinitions() throws FileNotFoundException, IOException {
		...
		List<PotionLoader.PotionDefinition> list = (List<PotionLoader.PotionDefinition>) XStreamUtil.getxStream().fromXML(new FileInputStream("./data/content/combat/potiondef.xml"));
		int count = 0;
