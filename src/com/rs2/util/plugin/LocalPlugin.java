...
/**
 * Represents a local plugin. Each player in the game server
 * has a unique instance of the running plugin allowing for
 * manipulation of per-player data.
 * @author Tommo
 *
 */
public abstract class LocalPlugin extends AbstractPlugin {
	...
	/**
	 * The player this instance of the
	 * plugin belongs to.
	 */
